...
import modifiedRandomForest.Evaluation;
import modifiedRandomForest.RandomTree;
 ...
 */
public class ModifiedRandomForest 
extends Classifier 
...
AdditionalMeasureProducer, TechnicalInformationHandler {
   ...
   <!-- options-end -->
	...
	public static void main(String[] argv) throws Exception {
		...
		Classifier cls = new ModifiedRandomForest();
