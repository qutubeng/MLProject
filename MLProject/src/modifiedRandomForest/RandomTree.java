...
WeightedInstancesHandler, Randomizable, Drawable {
	...
	//added by qutub
	protected ModifiedRandomForest m_MotherForest;
	...
	public double[] distributionForInstance(Instance instance) throws Exception {
	    ...
	    if (m_Attribute > -1) {  // ============================ node is not a leaf
	      ...
	      } else if (m_Info.attribute(m_Attribute).isNominal()) { // ------ nominal
...
/******************************************************************/
	...
	protected double priorVal(double[][] dist) {
		...
		//Edited by Qutub
		return SplitCriteria.entropyOverColumns(dist);
	}
	...
	protected double gain(double[][] dist, double priorVal) {
		...
		//Edited by Qutub
		return priorVal - SplitCriteria.entropyConditionedOnRows(dist);
	}
