...
TechnicalInformationHandler {
   ...
   <!-- options-end -->
	...
	public static void main(String [] argv) throws Exception{
		...
		//filePath = filePath + "/src/dataSets/evaluateAll.arff";
		filePath = filePath + "/src/dataSets/evaluateJoggingWalking.arff";
		//filePath = filePath + "/src/dataSets/evaluate.arff";
		//filePath = filePath + "/src/dataSets/Soyabean.arff";
		//filePath = filePath + "/src/dataSets/short.arff";
		...
		System.out.println(eval.toSummaryString("Result for fold: ", true));
		System.out.println(eval.toClassDetailsString("=== Detailed Accuracy By Class ==="));
		System.out.println(eval.toMatrixString("=== toMatrixString ==="));
