...
AdditionalMeasureProducer, TechnicalInformationHandler {
   ...
   <!-- options-end -->
	...
	public void myFunction() {
		...
		System.out.println("Out of bag error: "+m_bagger.measureOutOfBagError()); 
	}
	...
	public static void main(String[] argv) throws Exception {
		...
		filePath = filePath + "/src/dataSets/AccGroData.arff";
		...
		cls.buildClassifier(randData);
		evalTrain.crossValidateModel(cls, randData, 10, new Random());
		System.out.println(evalTrain.toSummaryString("==== toSummaryString ===", true));
		...
		/*for (int f=0; f < 10; f++) {
			...
			//evalTrain.crossValidateModel(cls, test, 10, new Random(1));
			//evalTrain.confusionMatrix();
			int folds = f+1; 
